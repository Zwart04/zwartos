...
Unduh ISO sistem operasi langsung ke flashdisk **Ventoy** lewat **WiFi**/LAN — pilih OS, ambil versi terbaru, reboot, boot. Satu flashdisk, banyak OS, tanpa siapkan ISO dari awal.

Daftar OS ada di **[`zwartos-oslist.txt`](zwartos-oslist.txt)** dan ditarik otomatis oleh ISO ZWARTOS tiap online. Robot (GitHub Action) memeriksa link & memperbarui versi tiap minggu.

**Diperiksa robot:** 2026-08-29 10:07 UTC — ✅ Aktif: **52** · ⚠️ Diragukan: **1** · ❌ Rusak: **1** · Total: **54**
...
- `Nama | https://folder/ | pola-nama-file` — **auto**: robot & ISO cari versi terbaru sendiri.
...
---
_README ini digenerate otomatis oleh robot (`refresh.sh` via GitHub Actions)._
